...
<head>
    ...
    <title>商品介紹</title>
    <link rel="stylesheet" href="assets/css/product2.css?5221">
...
<body>
    ...
    <section>
        ...
        <div class="productMain">
            ...
            <h2>經典商品|搜尋結果-「<%=request.getParameter("search") %>」的相關結果</h2>

            <% 
                sql = "select * from PRODUCT where ProductName like '%"+request.getParameter("search")+"%' ;";
